...
Carousel::Carousel(uint8_t _fsSpeed,
		uint8_t _fsZoom) :
...
std::vector<ButtonMapping> Carousel::getButtonMappings() {
...
boolean Carousel::onButtonPressed(uint8_t button) {
